...
<html lang="pt-br">
  ...
  <body>
        ...
        <form action="registroEquipamentos.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" name="tipo" id="" >
                    ...
                    <option value="Peças de equipamentos">Peças de equipamentos</option>
                    <option value="Acessórios utilitários">Acessórios utilitários</option>
                </select>
            </div>
